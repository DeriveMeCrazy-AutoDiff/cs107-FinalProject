...
def test_mul_vector_list():
    a = [1, 2, 3]
    b = [0.5, 0.2, 0.1]
    c = [2, 4, 6]
    d = [0.3, 0.6, 0.9]

    x0 = AutoDiff(a, [1,0,0,0])
    x1 = AutoDiff(b, [0,1,0,0])
    x2 = AutoDiff(c, [0,0,1,0])
    x3 = AutoDiff(d, [0,0,0,1])
